...
const webpackHotMiddleware = require("webpack-hot-middleware"); // require webpack-dev-middleware
...
if (environment === 'development') { // check if dev environment
    ...
    const compiler = webpack(config); // create compiler
    ...
    app.use(webpackHotMiddleware(compiler, { // TODO - needs something else to make HMR work with typescript
        log: console.log 
    }));
}
